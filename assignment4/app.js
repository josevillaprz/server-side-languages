...
var myname = () => { // 2. 'function' is misspelled
  const message = "here is my IP adress";
  return message; // 3. wasnt returning anything only console logging
};

async function callHttpbin() { // 4. missing async keyword
